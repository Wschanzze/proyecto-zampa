  ...
  return (
    <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-14">
        ...
        <p className="text-umber-light font-light max-w-2xl mx-auto text-base md:text-lg leading-relaxed">
            ...
            <div className="p-6 flex flex-col gap-3">
              ...
              <div className="pt-3 border-t border-charcoal/10 flex items-center justify-between">
                <a 
                  ...
                  className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-teal hover:text-teal-dark transition-colors"
                >
