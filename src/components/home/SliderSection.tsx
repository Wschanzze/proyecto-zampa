...
export default function SliderSection() {
  ...
  return (
    <section className="py-12 md:py-16 px-6 lg:px-12 bg-white flex justify-center items-center">
      <div 
        className="relative min-h-[550px] h-[75vh] max-h-[750px] w-full max-w-7xl overflow-hidden rounded-[32px] md:rounded-[40px] bg-black flex items-center justify-center lg:justify-start shadow-2xl"
      >
