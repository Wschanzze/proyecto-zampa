...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden flex items-end">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-6 lg:px-16 pb-24 lg:pb-32 pt-40">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end">
          ...
          <div className="lg:col-span-7 flex flex-col justify-end">
            <div className="mb-6 flex items-center gap-4">
              ...
              <p className="text-[10px] md:text-xs font-semibold tracking-[0.4em] text-white/90 uppercase drop-shadow-md">
                De Tandil a tu Mesa
              </p>
            </div>

            <div className="min-h-[140px] sm:min-h-[200px] lg:min-h-[260px] flex items-end">
              <h1
                ref={headlineRef}
                className="font-fraunces text-5xl sm:text-7xl lg:text-[90px] xl:text-[100px] font-light leading-[1.05] text-white uppercase tracking-wide drop-shadow-2xl">
          ...
          <div 
            ref={subRef}
            className="lg:col-span-5 flex flex-col lg:pb-4"
          >
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 lg:p-10 rounded-[2rem] shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-4">
                <a
                  href="#cultivars"
                  className="flex flex-1 items-center justify-center gap-3 h-14 rounded-full bg-white text-charcoal font-bold text-[11px] sm:text-xs hover:bg-white/90 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.1)] tracking-[0.15em] uppercase">
                ...
                <a
                  ...
                  className="flex flex-1 items-center justify-center gap-3 h-14 rounded-full border border-white/40 bg-white/5 text-white font-bold text-[11px] sm:text-xs hover:bg-white/20 hover:border-white transition-all duration-300 tracking-[0.15em] uppercase">
      ...
      {/* Scroll indicator - Moved to bottom right or integrated nicely */}
      <div className="absolute bottom-6 right-6 lg:bottom-12 lg:right-12 z-20 flex flex-col items-center gap-3 animate-bounce opacity-80">
