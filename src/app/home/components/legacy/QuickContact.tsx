    ...
    <section className="py-24 lg:py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <h2 className="font-fraunces text-4xl md:text-5xl font-light text-umber-dark leading-tight max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {contacts.map((item, idx) => (
            <div key={idx} className="flex flex-col items-center text-center p-8 rounded-[24px] bg-[#FAF8F5] border border-teal/5 shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <h4 className="font-fraunces text-lg font-semibold text-umber-dark mb-2">{item.title}</h4>
