    ...
    <section className="intro-section py-24 lg:py-32 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <h2 className="font-fraunces text-4xl md:text-5xl font-light text-umber-dark leading-tight">Nuestra Vocación</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative aspect-square w-full max-w-[500px] mx-auto rounded-[32px] overflow-hidden shadow-2xl border border-teal/5">
              ...
              <div className="absolute bottom-6 left-6 right-6 z-20 bg-teal/95 backdrop-blur-sm px-6 py-4 rounded-2xl shadow-xl flex items-center gap-4">
                <span className="font-fraunces text-4xl font-semibold text-wheat-light">100%</span>
          ...
          <div className="lg:col-span-6 flex flex-col gap-10">
            <div className="philosophy-item flex gap-6 items-start">
              <span className="font-fraunces text-4xl font-light text-teal/40 leading-none">01</span>
              <div>
                <h3 className="font-fraunces text-2xl font-semibold text-umber-dark mb-3">Integración Vertical: Del Pasto al Mostrador</h3>
            ...
            <div className="philosophy-item flex gap-6 items-start">
              <span className="font-fraunces text-4xl font-light text-teal/40 leading-none">02</span>
              <div>
                <h3 className="font-fraunces text-2xl font-semibold text-umber-dark mb-3">Materia Prima Noble: El Secreto de la Oveja</h3>
                <p className="text-sm md:text-base font-light text-charcoal/80 leading-relaxed">
                  <span className="desktop-text-only">
